    ...
    return (
        <>
            <div className="flex min-h-screen flex-col bg-[#f8f8f8] text-black dark:bg-[#050505] dark:text-white xl:h-screen xl:overflow-hidden">
                <MobileHeader title="wellness" href="/dashboard/wellness" subContent={mobileTabs} rightAccessory={mobileHeaderControls} titleAlign="left" />
                ...
                <header className="hidden lg:flex w-full items-center justify-between bg-white px-[40px] py-5 flex-none dark:bg-neutral-900 dark:border-b dark:border-white/10">
                    ...
                    <div className="flex flex-1 flex-wrap items-center justify-end gap-4">
                        ...
                        <nav className="flex flex-wrap gap-2 text-sm">
                            ...
                            <Link href="/dashboard/wellness" className="rounded-lg bg-zinc-900 px-4 py-2 font-medium text-white transition dark:bg-white dark:text-black">
                                wellness
                            </Link>
                            <Link
                                href="/dashboard/nutrition"
